...
//import com.challenge.foroalura.domain.*;
import com.challenge.foroalura.domain.usuario.*;
...
public class UsuarioController {
    ...
    @GetMapping
    public ResponseEntity<Page<DatosRespuestaUsuario>> listadoUsuarios(@PageableDefault(size = 5) Pageable paginacion) {
